    ...
    >
      ...
      <div className="px-4 sm:px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-md shadow-cyan-500/25 shrink-0">
          ...
          <button
            ...
            className={`group inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 ${
              isActive
                ...
                : 'bg-gradient-to-br from-cyan-700 to-cyan-500 text-white shadow-md shadow-cyan-500/30 hover:shadow-lg hover:scale-105'
            }`}
          >
            {isActive ? (
              <>

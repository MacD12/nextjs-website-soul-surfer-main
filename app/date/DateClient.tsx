      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-cyan-50/30 to-white flex flex-col pt-[96px] sm:pt-[104px] pb-[110px] sm:pb-[120px]">
        <div className="flex-1 mx-auto w-full max-w-6xl px-4 sm:px-6 flex flex-col">
          ...
          >
            ...
            <h1 className="mt-1.5 font-onest text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-gray-800">
              Select Your Dates
            </h1>
            <motion.div
            ...
            >
              <div className="calendar-shell flex-1 lg:min-h-0 flex flex-col lg:overflow-hidden rounded-2xl bg-white ring-1 ring-gray-100 shadow-lg p-4 sm:p-5">
                ...
                <div className="flex items-center gap-2.5 mb-3 shrink-0">
                  <div className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-md shadow-cyan-500/20">
                    <Calendar className="w-4 h-4 text-white" strokeWidth={2.25} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h2 className="font-onest text-sm sm:text-base font-bold tracking-tight text-gray-800 leading-tight">
                      Choose your stay
                    </h2>
                  ...
                  <DatePicker
                    ...
                    renderCustomHeader={({
                      ...
                      <div className="flex items-center justify-between px-1 py-1.5">
                        ...
                        <h3 className="font-onest text-sm font-bold tracking-tight text-gray-800 tabular-nums">
                ...
                <div className="mt-3 shrink-0 space-y-2.5">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[10px] text-gray-400">
                    <span className="inline-flex items-center gap-1">
                      <span className="block w-2.5 h-2.5 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500" />
                      Selected
                    </span>
                    <span className="inline-flex items-center gap-1">
              ...
              <AnimatePresence>
                {nightCount > 0 && (
                  ...
                  >
                    ...
                    <div className="font-onest text-base sm:text-lg font-bold tabular-nums text-gray-800">
                      {nightCount}{' '}
              ...
              {canProceed ? (
                <div className="lg:flex-1 lg:min-h-0 flex flex-col gap-3 sm:gap-3.5">
                  ...
                  <div className="shrink-0 rounded-2xl bg-white ring-1 ring-gray-100 shadow-md p-4 sm:p-5">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="shrink-0 flex flex-col items-center">
                        <div className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 text-white text-[9px] font-bold shadow-md shadow-cyan-500/30">
                          IN
                        </div>
                      ...
                      <div className="flex-1 relative h-1.5 rounded-full bg-gradient-to-r from-cyan-700 to-cyan-500">
                  ...
                  <div className="lg:flex-1 lg:min-h-0 flex flex-col justify-center rounded-2xl bg-gradient-to-br from-cyan-50/40 via-white to-white ring-1 ring-cyan-100/60 p-4 sm:p-5">
                    ...
                    <p className="font-onest text-sm sm:text-base font-bold tracking-tight text-gray-800 leading-tight mb-1">
...
const DateTile = ({
  ...
  >
    ...
    {active && date ? (
      <>
        <p className="mt-0.5 font-onest text-sm sm:text-base font-bold tracking-tight text-gray-800 tabular-nums leading-tight">
          {formatShort(date)}
        </p>

          ...
          {personCount > 0 && (
            ...
            >
              <div className="flex items-center gap-2 text-xs sm:text-sm">
                ...
                <span className="font-onest font-bold text-gray-800 tabular-nums">
                  {personCount}
                </span>
              </div>
              <div className="flex items-center gap-2 text-xs sm:text-sm">
                ...
                <span className="font-onest font-bold text-gray-800">
                  {selectedCamp || '-'}
                </span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-5 flex justify-end">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 text-white text-sm font-semibold shadow-md shadow-cyan-500/25 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200"
                >
                  OK
                </button>
              </div>

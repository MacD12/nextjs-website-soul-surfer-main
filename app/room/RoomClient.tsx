...
import RoomCarousel from '@/components/booking/RoomCarousel';
            ...
            >
              ...
              <div className="rounded-2xl bg-white ring-1 ring-gray-100 shadow-md p-5 sm:p-6 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="inline-flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-md shadow-cyan-500/25">
                ...
                <div className="inline-flex items-center gap-3 sm:gap-4 px-2 py-1 rounded-full bg-gray-50 ring-1 ring-gray-200">
                  ...
                  <span className="min-w-[2rem] text-center font-onest text-xl sm:text-2xl font-bold tabular-nums text-gray-800">
                    {peopleCount}
                  </span>
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 text-white shadow-md shadow-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/50 hover:scale-105 active:scale-95 transition-all duration-200"
                  >
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 flex flex-col p-4">
                            <h3 className="font-onest text-sm sm:text-base font-bold tracking-tight text-gray-800 leading-tight">
                              {room.title}
                            </h3>

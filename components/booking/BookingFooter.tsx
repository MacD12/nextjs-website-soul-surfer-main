...
const StepCircle = ({
  ...
  const variants = {
    done: 'bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-md shadow-cyan-500/30',
    active:
      'bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-lg shadow-cyan-500/50 ring-4 ring-cyan-200',
...
const Connector = ({ filled }: { filled: 'full' | 'half' | 'none' }) => {
  ...
  return (
    <div className="flex-1 relative h-0.5 mx-1 mt-5 lg:mt-[22px] rounded-full bg-gray-200 overflow-hidden">
      <motion.div
        className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-cyan-700 to-cyan-500"
        initial={{ width: 0 }}
        animate={{ width }}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div className="md:hidden">
          ...
          <div className="relative h-2 w-full rounded-full bg-gray-100 overflow-hidden ring-1 ring-gray-200">
            <motion.div
              className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-cyan-700 via-cyan-500 to-cyan-400 shadow-[0_0_12px_rgba(34,211,238,0.5)]"
              initial={{ width: 0 }}

    ...
    <div className="p-5 sm:p-6">
      ...
      <div className="flex items-center justify-between gap-3 mb-1">
        <div className="flex items-center gap-2.5">
          <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-md shadow-cyan-500/20">
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-gradient-to-br from-cyan-700 to-cyan-500 shadow-sm">
                  ...
                  <div className="text-right">
                    <span className="font-onest text-xl sm:text-2xl font-bold tabular-nums text-gray-800 leading-none">
                      €{totalPrice}
                    </span>
